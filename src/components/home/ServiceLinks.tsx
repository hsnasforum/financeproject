...
const serviceLinks = [
  { label: "홈/대시보드", description: "최근 플랜과 다음 액션을 먼저 확인", href: "/dashboard", badge: "시작" },
  { label: "재무진단", description: "내 수입·지출·부채 흐름을 진단", href: "/planning", badge: "진단" },
  { label: "상품추천", description: "조건에 맞는 예적금·대출 후보 비교", href: "/recommend", badge: "추천" },
