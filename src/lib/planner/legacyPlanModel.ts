/**
 * @deprecated
 * 신규 금융 계산 로직은 src/lib/planning/engine/* 를 통해 추가합니다.
 * 이 파일은 legacy planner 제거 전 임시 전이층입니다.
 * 신규 정책/규칙 추가를 금지하며, 소비 경로를 engine 계약으로 이관한 뒤 삭제합니다.
 * Sunset target: 2026-04-30.
 */
