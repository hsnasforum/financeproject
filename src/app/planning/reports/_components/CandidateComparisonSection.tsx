                ...
                {comparedRows.length < 1 ? (
                  ...
                  <tr key={row.id}>
                    <td className="px-3 py-2">
                      ...
                      <details className="mt-1 rounded border border-slate-200 bg-slate-50 px-2 py-1 text-[11px] text-slate-700">
                        <summary className="cursor-pointer font-semibold text-slate-800">이자 추정 근거</summary>
