...
export default async function SavingProductsPage({
  searchParams,
}: {
  ...
  return <ProductListPage kind="saving" title="적금 상품" ratePreference="higher" initialTopFinGrpNo={topFinGrpNo} initialPageNo={pageNo} />;
}
