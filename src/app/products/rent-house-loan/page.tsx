...
export default async function RentHouseLoanProductsPage({
  searchParams,
}: {
  ...
  return <ProductListPage kind="rent-house-loan" title="전세자금대출 상품" ratePreference="lower" initialTopFinGrpNo={topFinGrpNo} initialPageNo={pageNo} />;
}
