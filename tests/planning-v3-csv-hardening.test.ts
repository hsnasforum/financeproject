...
describe("planning v3 csv hardening", () => {
  it("detects tab delimiter and parses TSV rows deterministically", () => {
    ...
    expect(parsed.transactions).toEqual([
      { date: "2026-03-01", amountKrw: 1200, description: "salary", source: "csv", meta: { rowIndex: 1 } },
      { date: "2026-03-02", amountKrw: -300, description: "coffee", source: "csv", meta: { rowIndex: 2 } },
    ]);
  });
