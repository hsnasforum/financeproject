      ...
      <div className="relative z-10">
        ...
        {!state.loading && state.payload?.ok && state.payload.data ? (
          <div className="space-y-4">
            ...
            {typeof state.payload.meta?.fallbackDays === "number" && state.payload.meta.fallbackDays > 0 && (
              <p className="text-[10px] font-bold text-amber-600 italic text-center">
                * 영업일 기준 최근 데이터로 대체되었습니다.
              </p>
            )}
          </div>
        ) : null}
