                ...
                {runs.length === 0 ? (
                  ...
                  return (
                    <tr className="border-b border-slate-100" key={run.id}>
                      ...
                      <td className="px-2 py-2" data-testid={`run-action-completion-${run.id}`}>{completion}%</td>
                    ...
                    대시보드
                        ...
                        {pdfEnabled ? (
                          <a
                            ...
                            href={`/api/planning/v2/runs/${encodeURIComponent(run.id)}/report.pdf`}
                          >
                            Download PDF
                          </a>
                        ) : null}
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  ...
                  {pdfEnabled ? (
                    <a
                      ...
                      href={`/api/planning/v2/runs/${encodeURIComponent(selectedRun.id)}/report.pdf`}
                    >
                      Download PDF
                    </a>
                  ) : null}
