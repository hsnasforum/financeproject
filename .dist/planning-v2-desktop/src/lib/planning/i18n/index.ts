...
export const messages: Record<Locale, Record<string, string>> = {
  "ko-KR": {
    ...
    SUMMARY_LABEL_GENERATED_AT: "생성 시각",
    SUMMARY_LABEL_SNAPSHOT_ID: "스냅샷 ID",
    SUMMARY_LABEL_SNAPSHOT_AS_OF: "스냅샷 기준일(asOf)",
    SUMMARY_LABEL_SNAPSHOT_FETCHED_AT: "스냅샷 수집 시각",
    SUMMARY_LABEL_HEALTH_WARNINGS: "가정 건강도 경고",
    SUMMARY_LABEL_HEALTH_CRITICAL: "가정 건강도 치명 경고",
