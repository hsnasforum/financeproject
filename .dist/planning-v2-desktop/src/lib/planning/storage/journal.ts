...
export type StorageTxKind = "RUN_CREATE" | "RUN_INDEX_UPDATE" | "SNAPSHOT_WRITE" | "MIGRATION_APPLY";
...
function normalizeKind(value: unknown): StorageTxKind | null {
  ...
  if (kind === "RUN_CREATE" || kind === "RUN_INDEX_UPDATE" || kind === "SNAPSHOT_WRITE" || kind === "MIGRATION_APPLY") return kind;
  return null;
}
